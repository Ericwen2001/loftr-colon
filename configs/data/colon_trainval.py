...
cfg.DATASET.TRAINVAL_DATA_SOURCE = "Colon"
cfg.DATASET.TRAIN_DATA_ROOT = "C:/datasets/synapse/syntheticColon_I/"
...
cfg.DATASET.TEST_DATA_SOURCE = "Colon"
cfg.DATASET.VAL_DATA_ROOT = cfg.DATASET.TEST_DATA_ROOT = "C:/datasets/synapse/syntheticColon_I/"
