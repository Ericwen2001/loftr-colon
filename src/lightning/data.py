...
from src.datasets.syntheticColon import ColonDataset
            ...
            if data_source == 'ScanNet':
                ...
                datasets.append(
                    HomoDataset(data_root,
                                ...
                                augment_fn=augment_fn,
                                pose_dir=pose_dir))
            elif data_source == 'Colon':
                if mode == 'test':
                    datasets.append(ColonDataset(data_root,scene='S14',length=10,mode=mode))
                else:
                    datasets.append(ColonDataset(data_root,scene='S1',length=1199,mode=mode))
                    datasets.append(ColonDataset(data_root,scene='S2',length=1199,mode=mode))
                    datasets.append(ColonDataset(data_root,scene='S3',length=1199,mode=mode))
                    datasets.append(ColonDataset(data_root,scene='S4',length=1199,mode=mode))
                    datasets.append(ColonDataset(data_root,scene='S6',length=1199,mode=mode))
                    datasets.append(ColonDataset(data_root,scene='S7',length=1199,mode=mode))
                    datasets.append(ColonDataset(data_root,scene='S8',length=1199,mode=mode))
                    datasets.append(ColonDataset(data_root,scene='S9',length=1199,mode=mode))
                    datasets.append(ColonDataset(data_root,scene='S11',length=1199,mode=mode))
                    datasets.append(ColonDataset(data_root,scene='S12',length=1199,mode=mode))
                    datasets.append(ColonDataset(data_root,scene='S13',length=1199,mode=mode))
            else:
